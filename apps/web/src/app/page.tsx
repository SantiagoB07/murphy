...
import { Activity, ArrowRight, Zap, Shield, LogIn, UserPlus } from 'lucide-react';
    ...
    <div className="min-h-screen flex flex-col safe-area-inset">
      ...
      <main className="relative z-10 flex-1 flex flex-col items-center justify-center px-6 py-12">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="text-hig-lg md:text-hig-xl text-muted-foreground mb-8 animate-fade-up stagger-1 leading-hig-normal">
            Continúa gestionando tu salud y bienestar.
          </p>

          <Link href="/dashboard">
            <Button size="lg" className="animate-fade-up stagger-2">
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background">
      <div className="text-center space-y-4">
        <div className="w-10 h-10 mx-auto rounded-hig bg-gradient-purple flex items-center justify-center elevation-1 animate-pulse">
          <Activity className="w-[var(--icon-lg)] h-[var(--icon-lg)] text-foreground" aria-hidden="true" />
        </div>
