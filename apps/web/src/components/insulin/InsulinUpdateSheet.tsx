...
import { RAPID_INSULIN_BRANDS, BASAL_INSULIN_BRANDS } from "@/types/diabetes"
        ...
        <Form {...form}>
          ...
          >
                ...
                <FormItem>
                  ...
                  <FormControl>
                    <div className="flex gap-2 flex-wrap">
                      {Array.from({ length: maxFrequency }, (_, i) => i + 1).map(
                        (num) => (
                          <Button
                            key={num}
                            type="button"
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="flex flex-col">
                  ...
                  <FormDescription>
                    Desde cuando aplica este cambio
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>Medico que ordeno (opcional)</FormLabel>
                  <FormControl>
                    <Input placeholder="Dr. Garcia" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
