      ...
      <div className="flex flex-col items-center gap-6">
        ...
        >
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center">
            <Zap className="w-6 h-6 text-purple-400 mb-1" aria-hidden="true" />
        ...
        <div className="w-full max-w-xs space-y-4 text-center">
          ...
          <div className="p-3 rounded-xl bg-purple-500/10 border border-purple-500/20">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm text-muted-foreground">XP de hoy</span>
              </div>
          ...
          <div className="space-y-2">
            ...
            >
              <div
                className="h-full bg-gradient-to-r from-purple-500 to-purple-700 rounded-full transition-all duration-500 ease-out"
                style={{
                  width: `${(currentLevelXP / nextLevelThreshold) * 100}%`,
                }}
              />
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-3" role="list" aria-label="Estadísticas">
            <div className="bg-secondary/30 p-3 rounded-xl" role="listitem">
              <div className="flex items-center gap-2">
            ...
            <div className="bg-secondary/30 p-3 rounded-xl" role="listitem">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <p className="text-xs text-muted-foreground">Slots hoy</p>
                  <p className="font-semibold text-foreground text-sm">
                    {slotsToday}/6
                  </p>
                </div>
