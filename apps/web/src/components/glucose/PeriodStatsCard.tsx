      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        <article className="glass-card p-4">
          <div className="flex items-center gap-2 mb-1">
            ...
            <span className="text-xs text-muted-foreground">Mediciones</span>
          </div>
          <p className="text-xl font-bold text-foreground">{stats.count}</p>
          <p className="text-xs text-muted-foreground">
            {stats.avgTakesPerDay} tomas/dia
          </p>
        </article>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
        <article className="glass-card p-4">
          <div className="flex items-center gap-2 mb-1">
            ...
            <span className="text-xs text-muted-foreground">En rango (70-180)</span>
          </div>
        ...
        <article className="glass-card p-4">
          <div className="flex items-center gap-2 mb-1">
            ...
            <span className="text-xs text-muted-foreground">Dias con registro</span>
          </div>
          <p className="text-xl font-bold text-foreground">
            {stats.daysWithRecordsPercent}%
          </p>
          <p className="text-xs text-muted-foreground">
            {stats.daysWithRecords} de {stats.totalDays} dias
          </p>
        </article>
