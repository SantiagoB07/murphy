...
/**
 * ID del paciente por defecto para desarrollo
 * María García López - primer paciente del seed
 * 
 * Para obtener el ID actual, ejecutar:
 * npm run seed (verás el ID en la consola)
 * 
 * O usar getDefaultPatientId() que lo obtiene de la DB
 */
export const DEV_PATIENT_PHONE = '+573012052395'; // María's phone - usado para buscar el paciente
