...
interface HabitTrackerCardProps {
  date?: string;
  sleepData?: { hours: number } | null;
  stressData?: boolean;
  dizzinessData?: boolean;
  onSleepClick: () => void;
  onStressClick: () => void;
...
export function HabitTrackerCard({ 
  ...
  const wellnessItems: WellnessItem[] = [
    { 
      ...
      value: sleepData ? `${sleepData.hours}h` : undefined,
    ...
    { 
      ...
      value: stressData !== undefined ? (stressData ? 'Sí' : 'No') : undefined,
      status: stressData !== undefined ? 'recorded' : 'pending'
    },
    { 
      id: 'dizziness', 
      label: 'Mareos', 
      ...
      value: dizzinessData !== undefined ? (dizzinessData ? 'Sí' : 'No') : undefined,
      status: dizzinessData !== undefined ? 'recorded' : 'pending'
    },
  ];
