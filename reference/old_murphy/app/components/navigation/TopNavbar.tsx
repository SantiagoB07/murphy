...
import { getNavItems, getHomeRoute, getSettingsRoute } from '@/app/lib/navigation';
  ...
  return (
    ...
    >
      <div className="w-full max-w-7xl mx-auto px-4 lg:px-6 flex items-center justify-between">
        {/* Logo */}
        <Link href={homeRoute} className="flex items-center gap-2 shrink-0">
          ...
          <span className="font-semibold text-foreground text-hig-base">DiabetesManager</span>
        </Link>
